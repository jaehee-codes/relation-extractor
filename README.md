...
MALT_PARSER_SHELL_DIR = "/home/admin/Desktop/semafor/bin/runMalt.sh";
INPUT_FILE_DIR = "/home/admin/Documents/workspace/MmkgRelationExtractor/src/extractor/lib/files/";
OUTPUT_DIR = "/home/admin/Desktop/semafor/output";
```
...
```sh
/bin/sh -c cat /home/admin/Desktop/semafor/output/conll | nc localhost 8888
```
